            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(player?.completedMissions.toString() ?? '', style: roboto26whiteBold),
                    Text(player?.lionsEarned.toString() ?? '', style: roboto26whiteBold),
                    Text(player?.playTime.toString() ?? '', style: roboto26whiteBold),
                  ],
                ),
              )
            ],
